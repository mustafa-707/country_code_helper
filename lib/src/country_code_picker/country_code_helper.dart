...
class CountryCode {
  ...
  static Future<Country> initCountry([
    ...
    try {
      ...
      if (countryCode == null) {
        ...
        return mapToUse.values.first;
      }

      // Find the first entry in the map where countryCode matches
      final entry = mapToUse.entries.firstWhere(
        (entry) =>
            entry.value.countryCode.toLowerCase() == countryCode.toLowerCase(),
        // fallback to first entry if not found
        orElse: () => mapToUse.entries.first,
      );

      return entry.value;
    } catch (e) {
      // Handle errors here, return a default country or throw an exception
  ...
  static List<String> arabCountries = [
    "PS", // Palestine
    "JO", // Jordan
    "SA", // Saudi Arabia
    "DZ", // Algeria
  ...
  static List<String> westernEuropeanCountries = [
    "AD", // Andorra
    "BE", // Belgium
    "DK", // Denmark
    "FI", // Finland
  ...
  static List<String> easternEuropeanCountries = [
    "AL", // Albania
    "AM", // Armenia
    "AT", // Austria
    "AZ", // Azerbaijan
  ...
  static List<String> stanCountries = [
    "AF", // Afghanistan
    "KZ", // Kazakhstan
    "KG", // Kyrgyzstan
    "PK", // Pakistan
  ...
  static List<String> africanCountries = [
    "AO", // Angola
    "BJ", // Benin
    "BW", // Botswana
    "BF", // Burkina Faso
